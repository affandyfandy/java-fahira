package com.assignment.user.constant;
...
public abstract class AppConstant {
    ...
    public static final String CUSTOMER_SERVICE_HOST = "http://PRODUCT-SERVICE/product-service";
    public static final String CUSTOMER_SERVICE_API_URL = "http://PRODUCT-SERVICE/product-service/api/products";
